...
const ClergyPage: React.FC = () => {
  const clergyMembers: ClergyMember[] = [
    ...
    },
    {
      ...
      title: "Bishop",
      description: "Supporting the Presiding Bishop in pastoral care and administrative duties. Bishop Sinametor also oversees the Nsawam branch of the church.",
    ...
    },
    {
      ...
      title: "Bishop",
      description: "Overseeing church operations and providing spiritual guidance to multiple congregations.",
    ...
    },
    {
      ...
      title: "Elder",
      description: "Supporting church services, and leading the WMC Media Ministry.",
    ...
    },
    {
      ...
      title: "Elder",
      description: "Organizing the financial affairs of the church.",
